 ...
 * fluxos MP2 MPEG-2.
 */
public class MPEG2_MP2Constants extends MP2Constants {
	private static MPEG2_MP2Constants instance = null;
	...
	public static MPEGConstants getInstance () {
		if (instance==null) {
			instance = new MPEG2_MP2Constants(); 
		}
		return instance;
	}
	
	private MPEG2_MP2Constants () {
